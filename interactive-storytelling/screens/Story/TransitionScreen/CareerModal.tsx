...
export const careerToScreenMap: Record<string, keyof RootStackParamList> = {
    ...
    // Ambitious
    "Vision stratégique 🔭": "HedgeFundManagerStory",
    "Impact immédiat ⚡": "MediaMogulStory",
    "Opportunités manquées ⏳": "CorporateStrategistStory",
    "Charisme verbal 🎤": "PoliticalAdvisorStory",
    "Analyse des probabilités 🎲": "CasinoOwnerStory",
    "Inertie paralysante 🌀": "HighFrequencyTraderStory",
    "Prise de risques éclairée 🔥": "WallStreetTraderStory",
    "Investigation stratégique 🔎": "IntelligenceConsultantStory",
    "Refus du risque ❄️": "CrisisAdvisorStory",
    "Excellence académique 🎓": "NobelScientistStory",
    "Esprit entrepreneurial 🚀": "TechFounderStory",
    "Sens du risque 💰": "OffshoreBankerStory",
    "Ancrage émotionnel 🏡": "LuxuryDeveloperStory",
    "Détermination inébranlable 🚀": "FormulaOneDriverStory",
    "Lenteur stratégique ⏳": "EliteTaxConsultantStory",
    "Résilience absolue 💪": "SelfMadeBillionaireStory",
    "Détection des failles 🔎": "CorporateSpyStory",
    "Fragilité intérieure ⏳": "HostageNegotiatorStory",
    "Engagement total 🔥": "ArmsDealerStory",
    "Contrôle des racines 🌍": "DiplomaticStrategistStory",
    "Indécision fatale ⏳": "AuctionBrokerStory",
